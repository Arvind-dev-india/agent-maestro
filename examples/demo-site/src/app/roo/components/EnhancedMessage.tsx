      ...
      return (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 mb-2">
          <div className="flex items-center space-x-2 mb-2">
            <span className="font-medium text-purple-700">🌐 Browser Action</span>
      ...
      return (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-2">
          ...
          <div className="text-sm space-y-1">
            ...
            {data.uri && <div><strong>URI:</strong> {data.uri}</div>}
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            {data.tokensIn !== undefined && (
              <div>
                ...
                <span className="font-mono ml-1">{data.tokensIn.toLocaleString()}</span>
              </div>
            )}
            {data.tokensOut !== undefined && (
              <div>
                <span className="text-gray-600">Tokens Out:</span>
                <span className="font-mono ml-1">{data.tokensOut.toLocaleString()}</span>
              </div>
            )}
            ...
            {data.cost !== undefined && (
              <div className="col-span-2">
                ...
                <span className="font-mono ml-1 text-green-600">${data.cost.toFixed(6)}</span>
              </div>
            )}
          </div>
    ...
    if (data.question && data.suggest) {
      return (
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-2">
          <div className="font-medium text-green-700 mb-2">❓ Follow-up Question</div>
